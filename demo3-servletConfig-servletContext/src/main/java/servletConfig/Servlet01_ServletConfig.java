 ...
 * 注解方式：用WebServlet注解的initParams属性(config用的不多)
 */
@WebServlet(value = "/servlet1", initParams = {@WebInitParam(name="keya", value = "valueA"), @WebInitParam(name="keyb", value = "valueB")})
